...
//load database
	public PlayerRecord(Integer playerId, String userName, String name, String playerType, LocalDateTime createdAt,
	...
	private void validatePlayerType(String playerType) {
		if (playerType != null && !playerType.equals("HUMAN") && !playerType.equals("COMPUTER")) {
			throw new IllegalArgumentException("Player type must be 'HUMAN' or 'COMPUTER', got: " + playerType);
		}
	}
...
//Helper methods
	...
	public boolean isComputer() {
		return "COMPUTER".equals(playerType);
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(playerId, that.playerId) && Objects.equals(userName, that.userName);
	}
	...
	public String toString() {
		return String.format("PlayerRecord[id=%d, username='%s', type=%s]", playerId, userName, playerType);
	}
}
