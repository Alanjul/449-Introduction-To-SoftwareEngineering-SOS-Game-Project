...
public class DaoFactory {
	...
	//Create a StatsRecordDao instance
		...
		public static class DAOBundle
		{
	        ...
	        public DAOBundle(PlayerRecordDAO playerDAO, 
	                        GameRecordDao gameDAO,
	                        StatsRecordDao statsDAO) {
	            this.playerDAO = playerDAO;
	            this.gameDAO = gameDAO;
	            this.statsDAO = statsDAO;
	        }
	        
	        public PlayerRecordDAO getPlayerDAO() { return playerDAO; }
	        public GameRecordDao getGameDAO() { return gameDAO; }
	        public StatsRecordDao getStatsDAO() { return statsDAO; }
		}
}
