		...
		Winner winner)
{
    ...
    public static GameResult inProgress(String currentPlayerName, int blueScore, 
    		int redScore) {
        String message = currentPlayerName + "'s turn";
        return new GameResult(GameState.IN_PROGRESS, message, 
        		blueScore, redScore, Winner.NONE);
    }
