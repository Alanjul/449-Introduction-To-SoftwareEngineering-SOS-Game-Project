...
public abstract class Player {
	...
	public void setScore(int score) {
		if (score < 0) {
			throw new IllegalArgumentException(String.format("Score can not be negative, we got: %d ", score));
		}
		this.score = score;
	}
	...
	public void addScore(int points) {
		if (points < 0) {
			throw new IllegalArgumentException(String.format("Points can not be negative, got: %d", points));
		}
